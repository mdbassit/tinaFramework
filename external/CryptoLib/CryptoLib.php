...
class CryptoLib {
    ...
    public static function hash ($data, $salt = NULL, $raw_output = FALSE, $iterations = 96) {
        ...
        while ($iteration <= $outerIterations) {
            ...
            // use compat_pbkdf2 instead of the built-in hash_pbkdf2 for compatibility with php < 5.5
            $hashed = compat_pbkdf2($algorithm, $peppered, $salt, $pbkdf2Iteration, 0, $raw_output);
